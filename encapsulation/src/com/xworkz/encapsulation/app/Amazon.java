...
public class Amazon {
	 ...
	 private String productName;
	    ...
	    public void setPrimeEligible(boolean isPrimeEligible) {
	    ...
	    public void setGiftWrapAvailable(boolean isGiftWrapAvailable) {
	        this.isGiftWrapAvailable = isGiftWrapAvailable;
	    }
