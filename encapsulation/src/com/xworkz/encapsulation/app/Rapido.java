...
public class Rapido {
	 ...
	 private String riderName;
	    ...
	    public boolean isPrimeRide() {
	        return isPrimeRide;
	    }

	    public void setPrimeRide(boolean isPrimeRide) {
	        this.isPrimeRide = isPrimeRide;
	    }
	    ...
	    public void setRiderRated(boolean isRiderRated) {
	        this.isRiderRated = isRiderRated;
	    }
}
